...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
        <h5 class="text-left  text-lightblue mx-2 mt-2"><i class="fas fa-map-marker-alt "></i> Mikoa Yote      <a class="float-right btn btn-small bg-lightblue" href="ongeza_mkoa.php"><i class="fa fa-plus"></i> Ongeza Mkoa</a></h5>
  ...
  <section class="content mt-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    ?>
                   <p class="text-danger text-center">Samahani Hamna Mkoa uliosajiliwa !</p>
            ...
            <tr>
              ...
              <td>
                      ...
                      <a class="btn btn-block btn-sm bg-lightblue p-1" href="mkoa.php?id=<?php echo $row['reg_id'];?>"> Angalia Wilaya</i></a>
